...
def question1Flow():
    ...
    for i in range(20):
        ...
        conflicts = Util.countConflicts(agentList_question1)
...
if __name__ == "__main__":
    question1Flow()
    Util.drawConflictGraphs("outputs/question1_output.txt")